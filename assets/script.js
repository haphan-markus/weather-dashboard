...
console.log(historyEl.getElementsByTagName('button'));
...
Array.from(historyEl.getElementsByTagName('button')).forEach(function(el){
    el.addEventListener("click", function(btnEl){
        ...
        console.log(btnEl); //The action "click"
        console.log(btnEl.textContent); // Return undefined
        console.log(el); // The button itself
        console.log(el.textContent); // Return text value inside the button
